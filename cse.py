...
cse31 = Class('CSE 31', quarters=FALL | SPRING)
...
cse31L = Class('CSE 31L', units=3, quarters=FALL | WINTER)
cse45C = Class('CSE 45C')
math3D = Class('MATH 3D')
cse70A = Class('CSE 70A', quarters=WINTER)
cse46 = Class('CSE 46')
math3A = Class('MATH 3A')
cse112 = Class('CSE 112', quarters=FALL)
cse50 = Class('CSE 50', quarters=SPRING)

scicore1 = Class('SCIENCE', quarters=FALL)
scicore2 = Class('SCIENCE', quarters=WINTER)
scicore3 = Class('SCIENCE', quarters=SPRING)
cse132 = Class('CSE 132', quarters=FALL)
cse90 = Class('CSE 90', units=2)
in4matx43 = Class('IN4MATX 43', quarters=FALL | SPRING)
cse132L = Class('CSE 132L', units=3, quarters=WINTER)
cse141 = Class('CSE 141', quarters=FALL)
cse135A = Class('CSE 135A', quarters=FALL)
cse145 = Class('CSE 145-145L', units=6, quarters=SPRING)
cse142 = Class('CSE 142', quarters=WINTER)
cse135B = Class('CSE 135B', units=3, quarters=WINTER)
...
elective1 = Class('Elective')
elective2 = Class('Elective')
eecs148 = Class('EECS 148', quarters=FALL | SPRING)
compsci143A = Class('COMPSCI 143A', quarters=FALL | SPRING)
cse161 = Class('CSE 161', quarters=FALL | WINTER)
